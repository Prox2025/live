...
async function main() {
  ...
  const inicial = 'inicial_logo.mp4';
  const miraplay = 'miraplay_logo.mp4';
  const final = 'final_logo.mp4';
  ...
  for (const { id, nome } of [
    ...
    const comLogo = nome.replace('.mp4', '_logo.mp4');
    await aplicarLogo(nome, comLogo);
  }
